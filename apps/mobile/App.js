...
const scenarios = [
  ...
  { label: 'Walk to the station', note: '8:05 AM · active commute', activity: { app: 'Walking to the station', durationMin: 12, timeOfDay: '08:05' } },
  { label: 'Read on the train', note: '25 min · morning commute', activity: { app: 'Reading a book on the train', durationMin: 25, timeOfDay: '08:30' } },
  { label: 'Read a chapter', note: '20 min · 9:00 PM', activity: { app: 'Reading a book', durationMin: 20, timeOfDay: '21:00' } },
  { label: 'Late-night video scroll', note: '30 min · 10:45 PM', activity: { app: 'Watching short videos', durationMin: 30, timeOfDay: '22:45' } },
...
function GoalsEditor({ goals: initialGoals = [], habits: initialHabits = '', onSave, onCancel }) {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.onboarding}>
        ...
        <Text style={styles.habitLabel}>YOUR ROUTINE (OPTIONAL)</Text>
        <TextInput value={habits} onChangeText={setHabits} placeholder="e.g. I usually take a cab at 8:15 and scroll at night" placeholderTextColor="#82919A" style={styles.habitInput} multiline />
...
function HomeScreen({ goals, habits, onEditGoals }) {
